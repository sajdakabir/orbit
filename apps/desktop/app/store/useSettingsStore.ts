...
import { OrbitMode } from '../generated/orbit_pb'

import { ORBIT_MODE_SHORTCUT_DEFAULTS } from '@/lib/constants/keyboard-defaults'
import {
  normalizeChord,
  ShortcutResult,
...
interface SettingsState {
  ...
  setShowOrbitBarAlways: (show: boolean) => void
  ...
  createKeyboardShortcut: (mode: OrbitMode) => ShortcutResult
  removeKeyboardShortcut: (shortcutId: string) => void
  getOrbitModeShortcuts: (mode: OrbitMode) => KeyboardShortcutConfig[]
...
const getInitialState = () => {
  ...
  return {
    ...
    showOrbitBarAlways: storedSettings?.showOrbitBarAlways ?? true,
    ...
    keyboardShortcuts: storedSettings?.keyboardShortcuts ?? [
      {
        keys: ORBIT_MODE_SHORTCUT_DEFAULTS[OrbitMode.EDIT],
        mode: OrbitMode.EDIT,
        id: crypto.randomUUID(),
      },
      {
        keys: ORBIT_MODE_SHORTCUT_DEFAULTS[OrbitMode.TRANSCRIBE],
...
export const useSettingsStore = create<SettingsState>(set => {
  ...
  return {
    ...
    setShowOrbitBarAlways: createSetter('showOrbitBarAlways', 'general'),
    ...
    getOrbitModeShortcuts: (mode: OrbitMode) => {
