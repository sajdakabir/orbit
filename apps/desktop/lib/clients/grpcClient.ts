...
class GrpcClient {
  private client: ReturnType<typeof createClient<typeof OrbitService>>
  ...
  constructor() {
    ...
    this.client = createClient(OrbitService, transport)
  ...
  private async getHeadersWithMetadata(mode: OrbitMode) {
  ...
  async transcribeStream(stream: AsyncIterable<AudioChunk>, mode: OrbitMode) {
