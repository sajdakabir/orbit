...
import { OrbitMode } from '@/app/generated/orbit_pb.js'
import { ORBIT_MODE_SHORTCUT_DEFAULTS } from '../constants/keyboard-defaults.js'
    ...
    keyboardShortcuts: [
      {
        ...
        keys: ORBIT_MODE_SHORTCUT_DEFAULTS[OrbitMode.TRANSCRIBE].map(
          normalizeLegacyKey,
        ) as KeyName[],
      ...
      {
        id: crypto.randomUUID(),
        keys: ORBIT_MODE_SHORTCUT_DEFAULTS[OrbitMode.EDIT].map(
          normalizeLegacyKey,
        ) as KeyName[],
        mode: OrbitMode.EDIT,
      },
